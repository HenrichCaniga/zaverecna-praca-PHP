...
<div class="container mt-5">
    <h1 class="text-center text-white">Hlasujte anonymne za hru roka 2023!</h1>
    <form action="hlasovanie.php" method="POST" class="mt-4" onsubmit="return validateForm();">
        <div class="row">
            <div class="col-md-4 text-center">
                <img src="img/alanwake.jpeg" class="img-fluid" alt="Alan Wake 2">
                <div class="form-check mt-2">
                    <input type="radio" class="form-check-input" id="moznost1" name="moznost" value="4">
...
<script>
    function validateForm() {
        var selectedOption = document.querySelector('input[name="moznost"]:checked');
        if (!selectedOption) {
            alert("Vyberte jednu možnosť");
            return false;
        }
        return true;
    }
